...
ALTER SEQUENCE usuarios_id_seq RESTART WITH 1;</textarea>";
    ...
    echo "<div class='solucion'>";
    echo "<h3>🔧 SOLUCIÓN 2: SQL con ON CONFLICT (Recomendado)</h3>";
    echo "<p>SQL que maneja automáticamente los conflictos:</p>";
    echo "<textarea id='sqlConflict'>";
    ...
    foreach ($usuarios as $index => $usuario) {
        ...
        $codigoAfiliado = 'AF' . str_pad($index + 1, 4, '0', STR_PAD_LEFT);
    ...
    echo "</textarea>";
    echo "<button class='copy-btn' onclick='copiar(\"sqlConflict\")'>📋 COPIAR SQL CON MANEJO DE CONFLICTOS</button>";
    echo "</div>";
    
    echo "<div class='solucion'>";
    echo "<h3>🔧 SOLUCIÓN 3: SQL con códigos únicos</h3>";
    ...
    echo "<p>Luego usa la SOLUCIÓN 3: SQL con códigos únicos</p>";
